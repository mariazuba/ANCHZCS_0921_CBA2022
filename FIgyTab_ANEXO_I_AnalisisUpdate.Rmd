---
title: "Figuras y Tablas -  Sensibilidad a la actualización de datos de septiembre 2021"
lang: es
toc: TRUE
output: 
    pdf_document:
...
Emarzo    <- data.frame(Edadesflota_sept) %>% 
                        mutate (Asesoría='sept_2021') %>%
                        mutate (Edades= Edades)  %>% 
                        melt(id.var=c('Edades', 'Asesoría'))
...
EVmarzo    <- data.frame(EdadesCV_sept) %>% 
                        mutate (Asesoría='sept_2021') %>%
                        mutate (Edades= Edades)  %>% 
                        melt(id.var=c('Edades', 'Asesoría'))
...
EOmarzo    <- data.frame(EdadesCO_sept) %>% 
                        mutate (Asesoría='sept_2021') %>%
                        mutate (Edades= Edades)  %>% 
                        melt(id.var=c('Edades', 'Asesoría'))
...
Pmarzo    <- data.frame(Pesosflota_sept) %>% 
                        mutate (Asesoría='sept_2021') %>%
                        mutate (Edades= Edades)  %>% 
                        melt(id.var=c('Edades', 'Asesoría'))
